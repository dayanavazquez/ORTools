...
def save_rankings_to_txt(ranked_algorithms, p_value, output_file):
...
def load_file_and_analyze():
    file_path = "../problems/solutions/euclidean/solutions_vrppd/best_solutions_vrppd_euclidean_per_algorithm.csv"
    ...
    save_rankings_to_txt(ranked_algorithms, p_value, output_file)
