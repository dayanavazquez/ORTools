...
from cvrp.import_data import process_files_md
...
def main():
    ...
    instances_data = process_files_md()
    for instance, instance_data in instances_data.items():
        data = {"distance_matrix": instance_data["distance_matrix"], "depot": instance_data["depot"],
