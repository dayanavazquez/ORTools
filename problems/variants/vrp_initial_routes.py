...
def save_solution(
    ...
    solutions_dir = os.path.join(f"problems/{distance_type}/solutions_vrp_initial_routes_{i}/solutions_{solution_name}")
    try:
...
def execute(
        i, instance_type, time_limit, distance_type: DistanceType = None, heuristic: HeuristicType = None,
